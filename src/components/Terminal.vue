<template>
  <div class="terminal" @click="handleFocus">
    <div style="position:relative">
      ...
      <div style="position:absolute;top:0;left:0;right:0;overflow:auto;z-index:1;margin-top:30px;max-height:500px"
           ref="terminalWindow">
        <div class="terminal-window" id="terminalWindow">
          <span v-if="greeting !== false">
            <p v-if="greeting">{{greeting}}</p>
            <p v-else>智慧农业平台-在线技术支持</p>
          </span>
          <p v-if="showInitialCd">
            <span class="prompt"></span><span class="cmd">正在连接客服</span>
          </p>
